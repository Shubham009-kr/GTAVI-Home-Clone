    ...
    <>
      ...
      {heroContent && <div className='main w-full'>
        ...
        <div className='w-full h-screen p-16 relative'>
          <div className="flex items-center justify-between"><h1 className='text-4xl'>Official Trailer I</h1>
          <h1 className='font-[Helvetica] text-xs'>Released: December 4, 2023</h1></div>
